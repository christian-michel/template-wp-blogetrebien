...
jQuery(document).ready(function(){
	jQuery('.comment-reply-link').addClass('btn btn-default btn-sm btn-cmc btn-cmc-red btn-cmc btn-cmc-red btn-cmc btn-cmc-red btn-cmc btn-cmc-red');
	jQuery('button[type=submit]').addClass('btn btn-default');
	jQuery('#submit, html input[type=button], input[type=reset], input[type=submit]').addClass('btn btn-default btn-sm btn-cmc btn-cmc-red btn-cmc btn-cmc-red btn-cmc btn-cmc-red btn-cmc btn-cmc-red');
