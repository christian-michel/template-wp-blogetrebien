...
get_header(); ?>
	...
	<section id="blog">
		<div class="container stages">
			<div class="row">
				...
				?>
				N'hésitez pas à vous <strong>inscrire à la newsletter</strong> pour être tenu informé de toute modification ou mise à jour.<br/><br/>
				
				Les formations proposées par les différents professeurs sont les suivantes (ci-dessous).<br/>
				Notez que l'ordre d'affichage est volontairement aléatoire afin d'éviter que ce soit toujours la même qui soit en haut de page.
				</p>
	...
	<section>
		<div class="container">
			<div class="row">
				<div id="primary" class="col-sm-12" style="margin-top: 30px;">
