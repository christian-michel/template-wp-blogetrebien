            ...
            public function setSections() {
                ...
                $this->sections[] = array(
                    ...
                    'fields'    => array(
						...
						array( 
                            'title'     => __( 'Header Presentation ', 'ta-portfolio' ),
                            'subtitle'  => __( 'Add your own presentation for header region.', 'ta-portfolio' ),
                            'id'        => 'header_presentation',
                            'default'   => 'Ici mon texte de présentation',
                            'type'      => 'editor',
                        ),
                    )
                );

				//Portfolio Settings (Theme panel > Portfolio Settings ?)
                $this->sections[] = array(
                    'icon'      => 'el el-folder',
				...
				$this->sections[] = array(
                    ...
                    'fields'    => array(
                        array( 
                            ...
                            'subtitle'  => __( 'Add your own custom text/html for copyright region. You are <strong style="color:red;">not allowed</strong> to Remove Back Link/Credit unless you <a href="http://themeart.co/support-themeart/" target="_blank">donated us</a>.', 'ta-portfolio' ),
                            'id'        => 'custom_copyright',
                            'default'   => 'Copyright &copy; 2015 - <a href="http://themeart.co/free-theme/ta-portfolio/" title="TA Portfolio Free WordPress Theme" target="_blank">TA Portfolio</a>. Design by <a href="http://startbootstrap.com/" target="_blank">Start Bootstrap</a> and Developed by <a href="http://themeart.co/" title="Download Free Premium WordPress Themes" target="_blank">ThemeArt</a>.',
                            'type'      => 'editor',
                        ),
                    )
                );
